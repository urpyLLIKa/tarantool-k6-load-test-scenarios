...
docker rm tarantool
docker run -it --name tarantool -v /root/tarantool-k6-load-test-scenarios:/src:ro -p 3301:3301 -d tarantool/tarantool:${tarantool_ver} tarantool --config /src/tarantool/tarantool.yaml
